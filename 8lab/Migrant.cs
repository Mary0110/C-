...
namespace lab_3
{
    class Migrant
    {
        ...
        public Migrant(string firstName, string lastName, int age)
            : this(firstName, lastName, age, "-", 0, "-", "-", "-")
        {

        }
        public Migrant(string firstName, string lastName, int age, string education, int experience, string qualification, string maritalStatus, string regionOfBirth)
        {
        ...
        public virtual void BuyAccomodation()
        {
            if (_age < 18)
